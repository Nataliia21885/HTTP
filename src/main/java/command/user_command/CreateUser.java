...
public class CreateUser implements Command {
    ...
    public static final String CREATE_NEW_USER = "create_user";
    private final UserService userService;
    private final URI uri;

    public CreateUser(View view, UserService userService, URI uri) {
        this.view = view;
    ...
    public boolean canExecute(String input) {
        return input.equals(CREATE_NEW_USER);
    }
    ...
    public void execute() throws IOException, InterruptedException {
        ...
        System.out.println(userService.postUser(uri, user));
    }
}
